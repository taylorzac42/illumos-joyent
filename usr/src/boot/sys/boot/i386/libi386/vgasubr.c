...
void
vga_get_hardware_settings(u_int reg, int *width, int *height)
{
...
void
vga_set_atr(u_int reg, int i, int v)
{
	(void) GETB(reg, CGA_STAT);
	PUTB(reg, VGA_ATR_AD, i);
...
void
vga_set_indexed(u_int reg, int indexreg, int datareg,
...
int
vga_get_indexed(u_int reg, int indexreg, int datareg, uint8_t index)
{
	PUTB(reg, indexreg, index);
 ...
 */
void
vga_put_cmap(u_int reg, int index, uint8_t r, uint8_t g, uint8_t b)
{
...
void
vga_get_cmap(u_int reg, int index, uint8_t *r, uint8_t *g, uint8_t *b)
{
...
void
vga_dump_regs(u_int reg, int maxseq, int maxcrtc, int maxatr, int maxgrc)
{
	int i, j;
